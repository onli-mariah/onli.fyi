...
export default function HeritageCapitalWhitepaper() {
  const [content, setContent] = useState("");
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    fetch("/HERITAGE_CAPITAL_Use_Case_CORRECTED.md")
      .then((res) => res.text())
      .then((text) => {
        setContent(text);
        setLoading(false);
        ...
        <div className="container">
          ...
          <div className="flex items-center justify-between mb-12">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold">Heritage Capital</h1>
            </div>
            <Link href="/heritage-capital/calculator">
