...
export function Manufacturing() {
  ...
  useEffect(() => {
    fetch("/GLOBALTECH_Use_Case_CORRECTED.md?v=2")
      .then((res) => res.text())
      .then((text) => {
        setContent(text);
        setLoading(false);
      ...
      <section id="calculator" className="max-w-7xl mx-auto px-4 lg:px-8 fade-in-up delay-2" style={{ paddingTop: 'var(--spacing-xl)', borderTop: '1px solid #f0f0f0', marginTop: 'var(--spacing-xl)' }}>
        <div className="mb-12">
          ...
          <p className="text-muted-foreground text-center max-w-2xl mx-auto">
            Calculate your potential savings by eliminating intermediary fees and
            reducing settlement times with actual-possession technology.
          </p>
        </div>
